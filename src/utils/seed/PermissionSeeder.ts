...
const permissions = [
  ...
  { name: 'Voir un événement' },
  { name: 'Valider un événement' },
  { name: 'Rejeter un événement' },
  { name: 'Publier un événement' },
  { name: 'Archiver un événement' },
  { name: 'Déarchiver un événement' },

  { name: 'Créer une agence' },
  { name: 'Modifier une agence' },
  { name: 'Supprimer une agence' },
  { name: 'Voir les agences' },
  { name: 'Voir une agence' },
